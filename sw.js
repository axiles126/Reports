...
const NOTES = [
  'Звіти «День»/«Ніч» — зведення за зразком: авто-підрахунок вильотів, виявлених цілей і коригувань; поля втрат, пропелерів і дронів на позиції',
  'Прибрано «Старший групи» зі звітів і «Розвідка» за замовчуванням; до кожного коментаря/шаблону додається час',
  'Добовий звіт за новим зразком: інтервали розвідки лише на початку й у кінці, події з назвою позиції, необовʼязковий час завершення події',
